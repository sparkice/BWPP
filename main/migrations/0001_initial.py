# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-12 06:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Take_user', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-Push_time'],
            },
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_all', 'Can see all the infomation'), ('close_task', 'Can remove a task by setting its status as closed')),
            },
        ),
        migrations.CreateModel(
            name='UserProfile',
